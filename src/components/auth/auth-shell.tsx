  ...
  if (layout === "centered") {
    return (
      <section className="relative flex min-h-svh items-center justify-center bg-paper-50 px-5 py-12 sm:px-8 sm:py-16">
        <Link
          href="/"
          className="absolute left-5 top-5 inline-flex items-center gap-2 rounded-full border border-ink-900/10 bg-paper-50 px-3.5 py-2 text-[13px] font-medium text-ink-700 transition hover:border-ink-900/20 hover:text-ink-950 sm:left-8 sm:top-8 sm:px-4 sm:py-2.5 sm:text-[14px]"
        >
      ...
      >
        <aside className="relative hidden overflow-hidden bg-ink-950 text-paper-50 lg:flex lg:flex-col">
          ...
          <div className="relative flex flex-1 flex-col justify-between p-10 xl:p-14">
            <div>
              <Logo light href="/" />
              <p className="mt-10 inline-flex items-center gap-2 rounded-full border border-paper-50/12 bg-paper-50/[0.04] px-3 py-1.5 text-[11px] font-medium uppercase tracking-[0.18em] text-paper-100/70">
                <Sparkles className="h-3.5 w-3.5 text-accent-lime" />
                AI recruiting copilot
              </p>
              <h2 className="mt-8 max-w-md text-balance text-[clamp(2rem,3.5vw,2.75rem)] font-medium leading-[1.05] tracking-[-0.03em]">
                Hire 10x faster.{" "}
                <span className="font-serif italic text-gradient-brand">
                  With ten times the signal.
                </span>
              </h2>
              <p className="mt-5 max-w-sm text-pretty text-[15px] leading-relaxed text-paper-100/65">
            ...
            <div className="space-y-6">
              <ul className="space-y-3">
                {highlights.map((item) => (
                  <li
                    key={item}
                    className="flex items-center gap-2.5 text-[14px] text-paper-100/80"
                  >
              ...
              <div className="rounded-2xl border border-paper-50/10 bg-paper-50/[0.03] p-5 backdrop-blur">
                <p className="text-pretty text-[14px] leading-relaxed text-paper-100/75">
        ...
        <div className="flex flex-col justify-center px-5 py-10 sm:px-10 sm:py-14 lg:px-12 xl:px-16">
          <div className="mx-auto w-full max-w-[420px]">
            ...
            <div className="mb-8">
              <h1 className="text-balance text-[clamp(1.75rem,4vw,2.25rem)] font-medium leading-tight tracking-[-0.03em] text-ink-950">
                {title}
              </h1>
              {subtitle && (
