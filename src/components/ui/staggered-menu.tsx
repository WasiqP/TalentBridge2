...
export interface StaggeredMenuProps {
  ...
  onMenuClose?: () => void;
  isFixed?: boolean;
  /** Optional content rendered above the nav list (e.g. search). */
  panelHeader?: React.ReactNode;
  /** Optional content pinned to the bottom of the panel (e.g. legal, socials). */
  panelFooter?: React.ReactNode;
  /** Optional block below the footer (e.g. logout). */
  panelFooterBottom?: React.ReactNode;
  /** Optional block inserted after a nav item (e.g. search between links). */
    ...
    >
      ...
      <aside id="staggered-menu-panel" ref={panelRef} className="staggered-menu-panel" aria-hidden={!open}>
        <div className="sm-panel-inner">
            ...
            {items && items.length ? (
              items.map((it, idx) => (
                <React.Fragment key={it.link}>
                  ...
                  {panelMiddle != null && idx === panelMiddleAfterIndex ? (
                    <li className="sm-panel-insetWrap">
                      <div className="sm-panel-inset">{panelMiddle}</div>
                    </li>
                  ) : null}
                </React.Fragment>
              ))
          ...
          {panelFooter ? (
            <div className="sm-panel-footer">{panelFooter}</div>
          ) : null}
          {panelFooterBottom ? (
            <div className="sm-panel-footer-bottom">{panelFooterBottom}</div>
          ) : null}
        </div>
      </aside>
    </div>
